...
from did_iiot.did_iiot.did_document import Service, VerificationMethod, DIDDocument
...
class DHTHandler:
    ...
    def __init__(self,dilith_keys_dir="proxy1_keys_dilithium",kyber_keys_dir="proxy1_keys_kyber"):
